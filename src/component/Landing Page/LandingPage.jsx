...
<h2 className='text-8xl text-center font-[Great_Vibes]' style={{ fontFamily: 'Playfair Display' }}>
Will You be my
<span className='block text-8xl text-pink-700 mt-3'>Valentine?</span>
</h2>

<p className='text-2xl px-30 text-center text-[#59656f]' style={{ fontFamily: 'Lato' }}>
...
<button
onClick={() => setMood("bad")}
className='px-10 text-2xl py-3 cursor-pointer bg-black rounded-2xl shadow-3xl text-white flex items-center transition-all duration-300 hover:-translate-y-1'
style={{ fontFamily: 'Montserrat' }}>
No
</button>
</div>
